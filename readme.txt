=== SCD - Smart Currency Detector - Premium Variant for wcmp  ===
...
[WCMP (WCMP - Marketplace)](https://fr.wordpress.org/plugins/dc-woocommerce-multi-vendor/)
...
You can obtain a free 14-day trial license from our website: [SCD 14-day trial] (https://gajelabs.com/14-day-free-trial/)
...
We are really proud to serve and enhance WooCommerce, extending herewith the related community. We also have a successful jigoshop/wooCommerce migrator plugin.
...
= Presentation =
[youtube https://www.youtube.com/watch?v=iJCJgLvHH_g]

= How to use SCD (Smart Currency Detector)with WCMP =.
[youtube  https://www.youtube.com/watch?v=gUDGq5Fwpvo]


== DOCUMENTATION AND USAGE ==

Visit our documentation section on our website : [SCD DOCUMENTATION] (https://www.gajelabs.com/scd-documentation/)

= For marketplaces or Multi vendors sites =
 1- Go to "WooCommerce -> SCD Currencies -> CURRENCIES SETTINGS"
 2- Check "Multi roles based, webpages display currency" option then save changes.
 3- Each vendors/SHOP MANAGER can select his products prices in each currency he can handles.

= Add "SCD - Smart Currency Detector" Widget (SCD Widget) =

 1- Go to the admin view under "Appearance > Widgets" and select the SCD Widget 
 2- Choose a area in your website where you want to put in the widget. 
 3- Go back to your website: you can see the widget at the related place and your customers can start setting their own currency. 
...
A link to the terms of uses of these services is provided below:
   1 - IP geolocalization : [GeoPlugin Privacy Policy and User Agreement] (https://www.geoplugin.com/privacy/)
   2 - Currency conversion rates : [OpenExchange Terms of Use] (https://openexchangerates.org/terms/)
...
== CHANGELOG ==
= 4.7.9 =
* Fix vendor commission on email sends after an purchase 
= 4.7.8 =
* Remove some obsolete settings options on SCD currency settings in wcmp vendor dashboard 
* Change plugin name 
* Correct SCD currency settings integration in wcmp vendor dashbord menu for mobile view
= 4.7.7 =
* Fix vendor sale reports on wcmp vendor Dashboard
* Fix admin sale reports on wcmp admin Dashboard 
= 4.7.6 =
* Fix vendor commission issue with wcmp
* hithlight scd currency menu on wcmp dashboard after clicking on.
...
= 4.7.2 =
* Add register shiping methods in default currency for wcmp marketplace site 
...
= 4.6.0 =
* Fix double conversion in wcmp order page 
* Start using shorcode to place scd widget in any location of the website
= 4.5.9 =
* Fix can't disbale variation on wcmp dashbord when scd is activated
...
= 4.5.6 =
* Register variable product with user default currency in wcmp plugin
= 4.5.5 =
* use select2 library for wcmp integratio
...
= 4.5.1 =
wcmp improvement to allow vendor to use custom currency for setting product price
= 4.5.0 =
...
Fix plugin updater
= 4.4.8 =
wcmp improvement to allow vendor to use custom currency
= 4.4.7 =
...
= 4.4.0 =
Extend set user currency feature to wcmp plugin
= 4.3.9 =
Fixed widget issue
= 4.3.8 =
...
= 4.2.3 =
workarround of library chosen when update product using wcmp plugin
= 4.2.2 =
Add compatibility update product with wcmp plugins
= 4.2.1 =
